#!/usr/bin/env python3
"""PancakeSwap V3 Data Accuracy Verification Script"""
...
# PancakeSwap V3 uses same NFT Position Manager across all chains
...
def verify_pancakeswap_v3_accuracy(chain: str, pool_address: str, top_n: int = 10):
    ...
    nft_manager = w3.eth.contract(address=Web3.to_checksum_address(NONFUNGIBLE_POSITION_MANAGER), abi=NFT_ABI)
    matched = 0
...
if __name__ == "__main__":
    ...
    CHAIN = "base"
    POOL_ADDRESS = "0xb94b22332ABf5f89877A14Cc88f2aBC48c34B3Df"  # BSC WBNB/USDT
    
    result = verify_pancakeswap_v3_accuracy(CHAIN, POOL_ADDRESS, top_n=3)